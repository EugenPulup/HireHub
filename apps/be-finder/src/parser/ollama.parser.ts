...
type model = 'llama3' | 'mistrallite' | 'mistral' | 'llama3' | 'nexusraven';
...
class OllamaParser implements Parser {
  ...
  constructor(model: model) {
    ...
    this.systemPrompt =
      PromptTemplate.fromTemplate(`Extract and save the relevant entities mentioned in the following passage together with their properties. If there no properties set null as value
