...
export type CampaignQuery = {
  ...
  campaignCount: { __typename?: "Count"; count: number };
};
...
export type CandidatesQuery = {
  ...
  candidatesCount: { __typename?: "Count"; count: number };
};
...
export type RemoveCandidateMutation = {
  __typename?: "Mutation";
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "endType" } },
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "removeCampaignId" },
          },
          type: {
            kind: "NonNullType",
            type: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "listCampaignInput" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "campaignCount" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
...
export const CampaignByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CampaignById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<CampaignByIdQuery, CampaignByIdQueryVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "yearsOfExperience" },
                },
...
export const RemoveCandidateDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RemoveCandidate" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  RemoveCandidateMutationVariables
>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: { input: string; output: string };
