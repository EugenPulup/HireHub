...
export function graphql(
  source: "mutation CreateCampaign($createCampaignInput: CreateCampaignInput!) {\n  createCampaign(createCampaignInput: $createCampaignInput) {\n    endType\n    keyword\n    name\n    providers\n  }\n}\n\nmutation UpdateCampaign($id: String!, $updateCampaignInput: UpdateCampaignInput!) {\n  updateCampaign(id: $id, updateCampaignInput: $updateCampaignInput) {\n    endType\n    keyword\n    name\n    providers\n  }\n}\n\nmutation RemoveCampaign($removeCampaignId: [String!]!) {\n  removeCampaign(id: $removeCampaignId)\n}\n\nquery Campaign($listCampaignInput: ListCampaignInput!) {\n  campaign(ListCampaignInput: $listCampaignInput) {\n    name\n    keyword\n    status\n    providers\n    endType\n    endValue\n    id\n  }\n  campaignCount {\n    count\n  }\n}\n\nquery CampaignById($id: String!) {\n  campaignById(id: $id) {\n    name\n    keyword\n    status\n    providers\n    endType\n    endValue\n    id\n  }\n}"
): (typeof documents)["mutation CreateCampaign($createCampaignInput: CreateCampaignInput!) {\n  createCampaign(createCampaignInput: $createCampaignInput) {\n    endType\n    keyword\n    name\n    providers\n  }\n}\n\nmutation UpdateCampaign($id: String!, $updateCampaignInput: UpdateCampaignInput!) {\n  updateCampaign(id: $id, updateCampaignInput: $updateCampaignInput) {\n    endType\n    keyword\n    name\n    providers\n  }\n}\n\nmutation RemoveCampaign($removeCampaignId: [String!]!) {\n  removeCampaign(id: $removeCampaignId)\n}\n\nquery Campaign($listCampaignInput: ListCampaignInput!) {\n  campaign(ListCampaignInput: $listCampaignInput) {\n    name\n    keyword\n    status\n    providers\n    endType\n    endValue\n    id\n  }\n  campaignCount {\n    count\n  }\n}\n\nquery CampaignById($id: String!) {\n  campaignById(id: $id) {\n    name\n    keyword\n    status\n    providers\n    endType\n    endValue\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query Candidates($offset: Int!, $limit: Int!) {\n  candidates(offset: $offset, limit: $limit) {\n    id\n    name\n    position\n    salary\n    yearsOfExperience\n    createdAt\n  }\n  candidatesCount {\n    count\n  }\n}\n\nmutation RemoveCandidate($removeCandidate: [String!]!) {\n  removeCandidate(id: $removeCandidate)\n}"
): (typeof documents)["query Candidates($offset: Int!, $limit: Int!) {\n  candidates(offset: $offset, limit: $limit) {\n    id\n    name\n    position\n    salary\n    yearsOfExperience\n    createdAt\n  }\n  candidatesCount {\n    count\n  }\n}\n\nmutation RemoveCandidate($removeCandidate: [String!]!) {\n  removeCandidate(id: $removeCandidate)\n}"];
