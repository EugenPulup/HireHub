...
export type RangeAnalyticQuery = {
  __typename?: "Query";
  candidateRangeAnalytic: Array<{
    __typename?: "RangeAnalytic";
    date: string;
    count: number;
  }>;
...
export const RangeAnalyticDocument = {
  kind: "Document",
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "candidateRangeAnalytic" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "range" },
...
} as unknown as DocumentNode<RangeAnalyticQuery, RangeAnalyticQueryVariables>;
export const GroupByFieldDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GroupByField" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "groupAnalyticInput" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
} as unknown as DocumentNode<GroupByFieldQuery, GroupByFieldQueryVariables>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
  ID: { input: string; output: string };
  String: { input: string; output: string };
